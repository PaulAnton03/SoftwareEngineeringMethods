...
public class WireMockConfig {
    ...
    public static void startUserServer() {
        if (userMicroservice == null || !userMicroservice.isRunning()) {
            userMicroservice = new WireMockServer(WireMockConfiguration.options().port(USER_SERVER_PORT).dynamicPort());
    ...
    public static void startOrderServer() {
        if (orderMicroservice == null || !orderMicroservice.isRunning()) {
            orderMicroservice = new WireMockServer(WireMockConfiguration.options().port(ORDER_SERVER_PORT).dynamicPort());
