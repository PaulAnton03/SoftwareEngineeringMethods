...
class GeneralOrdersStrategyTest {
    ...
    void setUp() {
        ...
        this.order2 = new Order().id(22L).vendorId(2L).deliveryDestination(new Location().latitude(11F).longitude(22F)).status(Order.StatusEnum.PENDING);
        this.order3 = new Order().id(44L).vendorId(3L).deliveryDestination(new Location().latitude(11F).longitude(22F)).status(Order.StatusEnum.PREPARING);
        this.order4 = new Order().id(33L).vendorId(3L).deliveryDestination(new Location().latitude(11F).longitude(22F)).status(Order.StatusEnum.PREPARING);
